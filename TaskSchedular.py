#consider below python application which schedule task after Minute, hour as well as on specifi Day or specific time.
...
def fun_Afternoon():
    print("Current time is")
    print(datetime.datetime.now())
    print("Schedular executed after at 12")
